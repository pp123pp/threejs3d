...
var scratchAxis = new THREE.Vector3();
...
Cesium3DTileOptimizations.checkChildrenWithinParent = function(tile) {
    ...
    var childrenTile = tile.childrenTile;
    var length = childrenTile.length;
    ...
    if (boundingVolume instanceof TileOrientedBoundingBox /*|| boundingVolume instanceof TileBoundingRegion*/) {
        ...
        for (var i = 0; i < length; ++i) {
            ...
            var axis = scratchAxis.subVectors(childOrientedBoundingBox.center, orientedBoundingBox.center);
